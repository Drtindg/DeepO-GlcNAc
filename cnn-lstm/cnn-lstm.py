...
def k_fold(k, X_train, y_train, num_epochs=30, learning_rate=0.0001, weight_decay=0.00001, batch_size=5):
    ...
    for i in range(k):
        ...
        if valid_ls[-1][1] > best_valid_acc:
            torch.save(net.state_dict(), "16 30 best_model_cnn_lstm.pth")
...
model_path = "16 30 best_model_cnn_lstm.pth"
